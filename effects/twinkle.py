...
class TwinkleEffect:
    ...
    def get_params_info():
        """
        Возвращает информацию о параметрах эффекта "Случайное мерцание светодиодов".

        Returns:
            tuple: Кортеж, содержащий текстовое описание эффекта и словарь параметров.

            - str: Текстовое описание эффекта ("Несколько светодиодов случайным образом мерцают").
